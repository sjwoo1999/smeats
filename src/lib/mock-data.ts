...
export const mockProducts = [
  {
    ...
    image_path: "/images/products/pork-belly.jpg",
    stock: 100,
    min_order: 5,
    seller_id: "seller1",
  ...
  },
  {
    ...
    image_path: "/images/products/potato.jpg",
    stock: 200,
    min_order: 10,
    seller_id: "seller1",
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_path: "/images/products/onion.jpg",
    stock: 150,
    min_order: 10,
    seller_id: "seller2",
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_path: "/images/products/carrot.jpg",
    stock: 120,
    min_order: 10,
    seller_id: "seller2",
    created_at: new Date().toISOString(),
  },
  {
    ...
    image_path: "/images/products/beef-stew-meat.jpg",
    stock: 50,
    min_order: 3,
    seller_id: "seller1",
    created_at: new Date().toISOString(),
  },
  {
    ...
    price: 3000,
    description: "국내산 대파",
    image_path: "/images/products/scallion.jpg",
    stock: 80,
    min_order: 5,
    seller_id: "seller2",
    created_at: new Date().toISOString(),
...
export const mockRecipes = [
  {
    id: "1",
    name: "김치찌개",
    image_path: "/images/recipes/kimchi-jjigae.jpg",
  ...
  },
  {
    id: "2",
    name: "카레라이스",
    image_path: "/images/recipes/curry-rice.jpg",
  ...
  },
  {
    id: "3",
    name: "짜장면",
    image_path: "/images/recipes/jjajangmyeon.jpg",
  ...
  },
  {
    id: "4",
    name: "돈까스",
    image_path: "/images/recipes/tonkatsu.jpg",
  ...
  },
  {
    id: "5",
    name: "떡볶이",
    image_path: "/images/recipes/tteokbokki.jpg",
  ...
  },
  {
    id: "6",
    name: "샌드위치",
    image_path: "/images/recipes/sandwich.jpg",
